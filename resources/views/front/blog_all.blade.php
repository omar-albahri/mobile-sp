    ...
    <section id="basic-examples">
        <div class="row match-height">
            <div class="col-xl-4 col-md-6 col-sm-12">
                <div class="card" style="height: 466.078px;">
                    <div class="card-content">
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-btns d-flex justify-content-between mt-2">
                                <a href="#" class="btn gradient-light-primary text-white waves-effect waves-light">Download</a>
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            <div class="card-btns d-flex justify-content-between">
                                <a href="#" class="btn gradient-light-primary white waves-effect waves-light">Download</a>
                                <a href="#" class="btn btn-outline-primary float-right waves-effect waves-light">View All</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-content">
                        <div class="card-body text-center">
                            ...
                            <div class="card-btns d-flex justify-content-between">
                                ...
                                <button class="btn btn-outline-primary waves-effect waves-light">Message</button>
                            </div>
                            <hr class="my-2">
                            <div class="d-flex justify-content-between">
                                <div class="float-left">
                ...
                <div class="card" style="height: 329.656px;">
                    ...
                    <div class="card-content">
                        <div class="card-body text-center mx-auto">
                            ...
                            <button class="btn gradient-light-primary btn-block mt-2 waves-effect waves-light">Follow</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card chat-application">
                    ...
                    <div class="chat-app-window">
                        <div class="user-chats ps ps--active-y">
                            ...
                            <div class="ps__rail-x" style="left: 0px; bottom: -67px;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__rail-y" style="top: 67px; height: 415px; left: 377px;"><div class="ps__thumb-y" tabindex="0" style="top: 58px; height: 357px;"></div></div></div>
                        <div class="chat-footer">
                            <div class="card-body d-flex justify-content-around pt-0">
                                ...
                                <button type="button" class="btn btn-icon btn-primary waves-effect waves-light"><i class="feather icon-navigation"></i></button>
                            </div>
                        </div>
                    </div>
                </div>
